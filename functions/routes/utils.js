...
this.isRequestUidValid(req) - throws an error like: TypeError: this.isRequestUidValid is not a function

this.isRequestUidValid - I myself dont know how this works. Mostly its taking the ref of functions.
